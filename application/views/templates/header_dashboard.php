...
<head>
	...
	<link rel="icon" type="image/png" sizes="16x16"
		href="<?php echo base_url('assets/images/') ?>Logo-Al-Qodiri-Small-150x150.png">
	<!-- Pignose Calender -->
	<link href="<?php echo base_url('assets/theme/') ?>plugins/pg-calendar/css/pignose.calendar.min.css"
		rel="stylesheet">
	<!-- Chartist -->
	<link rel="stylesheet" href="<?php echo base_url('assets/theme/') ?>plugins/chartist/css/chartist.min.css">
	<link rel="stylesheet"
		href="<?php echo base_url('assets/theme/') ?>plugins/chartist-plugin-tooltips/css/chartist-plugin-tooltip.css">
	<!-- Custom Stylesheet -->
			...
			<div class="brand-logo">
				<a href="<?php echo base_url('dashboard'); ?>">
					<b class="logo-abbr"><img
							src="<?php echo base_url('assets/images/') ?>Logo-Al-Qodiri-Small-150x150.png" alt=""></b>
					<span class="logo-compact"><img
							src="<?php echo base_url('assets/images/') ?>Logo-Al-Qodiri-Small-150x150.png"
							alt=""></span>
					<span class="brand-title">
						<img src="<?php echo base_url('assets/images/') ?>Logo-Al-Qodiri-Small-150x150.png"
					...
					<ul class="clearfix">
						...
						<li class="icons dropdown">
							<div class="user-img c-pointer position-relative" data-toggle="dropdown">
								...
								<img src=" <?php echo base_url('assets/theme/') ?>images/user/1.png" height="40"
									width="40" alt="">
							</div>
							<div class="drop-down dropdown-profile animated fadeIn dropdown-menu">
								<div class="dropdown-content-body">
									<ul>
										<li>
											<a href="<?php echo base_url('profil_user') ?>"><i class="icon-user"></i>
												<span>Profil</span></a>
										</li>
		...
		<div class="nk-sidebar">
			<div class="nk-nav-scroll">
				<ul class="metismenu" id="menu">
					...
					<li class="nav-label">Dashboard</li>
					<li>
						<a href="<?php echo base_url('data_psb') ?>" aria-expanded="false">
							<i class="fa-solid fa-user-plus"></i><span class="nav-text">Data PSB</span>
						</a>
					</li>
					<li>
						...
						<ul aria-expanded="false">
							...
							<li><a href="<?php echo base_url('data_santri/tambah_santri') ?>">Tambah Santri Secara
									Manual</a></li>
							<li><a href="<?php echo base_url('data_santri/tambah_data_santri_massal') ?>">Tambah Santri
									Secara Massal (Excel)</a></li>
							<li><a href="<?php echo base_url('data_santri/kartu_santri') ?>">Kartu Tanda Santri
									(BETA)</a></li>
							<li><a href="<?php echo base_url('data_santri/set_kartu_santri') ?>">Setting Kartu
									Santri</a></li>
					...
					<?php if ($this->session->userdata('level') == 'ADMIN'): ?>
						<li>
							<a class="has-arrow" href="javascript:void()" aria-expanded="false">
								<i class="fa-solid fa-location-dot"></i> <span class="nav-text">Data Wilayah/Daerah
									(Asrama)</span>
							</a>
							<ul aria-expanded="false">
						...
						<li>
							...
							<ul aria-expanded="false">
								<li><a href="<?php echo base_url('data_lembaga_pendidikan') ?>">Data Lembaga Pendidikan</a>
								</li>
								<li><a href="<?php echo base_url('data_lembaga_pendidikan/tambah_lembaga') ?>">Tambah
										Lembaga Pendidikan</a></li>
						...
						<li>
							...
							<ul aria-expanded="false">
								...
								<li><a href="<?php echo base_url('data_tahun_ajaran/tambah_tahun_ajaran') ?>">Tambah Tahun
										Ajaran</a></li>
								...
								<li><a href="<?php echo base_url('data_rombel') ?>">Lihat Persebaran Rombel</a></li>
								<li><a href="<?php echo base_url('data_rombel/tambah_rombel') ?>">Tambah Siswa Dalam
										Rombel</a></li>
					...
					<li>
						<a class="has-arrow" href="javascript:void()" aria-expanded="false">
							<i class="fa-solid fa-list"></i><span class="nav-text">Data Penempatan Santri di
								Wilayah/Daerah (Asrama)</span>
						</a>
						<ul aria-expanded="false">
							<li><a href="<?php echo base_url('data_penempatan_santri') ?>">List Seluruh Penempatan
									Santri</a></li>
							<li><a href="<?php echo base_url('data_penempatan_santri/tambah_penempatan_santri') ?>">Tambah
									Penempatan Santri</a></li>
							<li><a href="<?php echo base_url('data_penempatan_santri/ekspor_data_santri') ?>">Ekspor
									Santri Perwilayah</a></li>
					...
					<li>
						<a class="has-arrow" href="javascript:void()" aria-expanded="false">
							<i class="fa-solid fa-check-to-slot"></i><span class="nav-text">Kelola Perizinan
								Santri</span>
						</a>
						<ul aria-expanded="false">
							<li><a href="<?php echo base_url('data_perizinan_santri') ?>">List Data/Status Perizinan
									Santri</a></li>
							<li><a href="<?php echo base_url('data_perizinan_santri/tambah_perizinan_santri') ?>">Tambah
									Perizinan Santri</a></li>
							<li><a href="<?php echo base_url('data_perizinan_santri/data_keperluan_izin') ?>">Data
									Keperluan Izin</a></li>
							<li><a href="<?php echo base_url('data_perizinan_santri/tambah_keperluan_izin') ?>">Tambah
									Keperluan Izin</a></li>
							<li><a href="<?php echo base_url('data_perizinan_santri/ekspor_rekapan_perizinan') ?>">Ekspor
									Rekapan Perizinan Santri</a></li>
					...
					<li>
						...
						<ul aria-expanded="false">
							...
							<li><a href="<?php echo base_url('data_santri_riyadhoh/tambah_santri_riyadhoh') ?>">Tambah
									Data Santri Riyadhoh</a></li>

							<li><a href="<?php echo base_url('data_santri_riyadhoh/cetak_santri_riyadhoh') ?>">Ekspor
									Data Santri Riyadhoh</a></li>
						</ul>
					</li>
					...
					<?php if ($this->session->userdata('level') == 'ADMIN'): ?>
						<li>
							...
							<ul aria-expanded="false">
								...
								<li><a href="<?php echo base_url('data_user/tambah_user') ?>" aria-expanded="false">Tambah
										User</a></li>
							</ul>
						<li>
