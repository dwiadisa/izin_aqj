                    ...
                    <div class="error-content">
                        <div class="card mb-0">
                            <div class="card-body text-center">
                                <!-- <h1 class="error-text text-primary">Sistem ini sedang dinonaktifkan</h1> -->
                                <h4 class="mt-4"><i class="fa-solid fa-circle-xmark"></i>
                                Sistem ini sedang dinonaktifkan <br>
                                
                                Silakan Menghubungi Admin untuk mengaktifkan kembali</h4>
                                <!-- <p>Akses halaman ini ditolak.</p> -->
                                <form class="mt-5 mb-5">
                                    
                                    <div class="text-center mb-4 mt-4"><a href="<?php echo base_url('auth') ?>" class="btn btn-success">Login</a>
                                    </div>
                                </form>
