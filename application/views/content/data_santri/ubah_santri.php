...
<<<<<<< HEAD
							<div class="form-group row">
								...
								<div class="col-lg-6">
									<input type="number" class="form-control" id="nik_santri" name="nik_santri" value="<?php echo $santri->nik_santri ?>" placeholder="Masukkan NIK Santri">
...
>>>>>>> c828bd154037bc276d83a44c67e059eff275fbd0
							...
							<div class="form-group row">
								...
								<div class="col-lg-6">
									<input type="text" class="form-control" id="pekerjaan_ibu" name="pekerjaan_ibu" value="<?php echo $santri->pekerjaan_ibu; ?>" placeholder="Masukkan Pekerjaan Ibu">
							...
							<div class="form-group row">
								<label class="col-lg-4 col-form-label" for="val-confirm-password">Status <span class="text-danger">*</span>
								</label>
								<div class="col-lg-6">
							...
							<div class="form-group row">
								<label class="col-lg-4 col-form-label" for="foto_santri">Foto Santri</label>
								<div class="col-lg-6">
									<input type="file" class="form-control-file" id="foto_santri" name="foto_santri">
								</div>
							</div>
							<div class="form-group row">
