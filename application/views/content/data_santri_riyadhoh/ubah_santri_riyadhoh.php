	...
	<div class="container-fluid">
		<div class="row justify-content-center">
			<div class="col-lg-12">
				<div class="card">
					<div class="card-body">
						<h4>Ubah Data Santri Riyadhoh</h4>
						<hr>
						<div class="form-validation">
							<form class="form-valide" action="#" method="post" novalidate="novalidate">
								<div class="form-group row">
									...
									<div class="col-lg-6">
										<input type="text" class="form-control" id="nama_santri_riyadhoh" name="nama_santri_riyadhoh" value="<?php echo $data_santri->nama_santri_riyadhoh; ?>" placeholder="Masukkan Nama Santri Riyadhoh..">
								...
								<div class="form-group row">
									...
									<div class="col-lg-6">
										<input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir" value="<?php echo $data_santri->tempat_lahir; ?>" placeholder="Masukkan Tempat Lahir..">
								...
								<div class="form-group row">
									...
									<div class="col-lg-6">
										<input type="date" class="form-control" id="tanggal_lahir" name="tanggal_lahir" value="<?php echo $data_santri->tanggal_lahir; ?>">
								...
								<div class="form-group row">
									...
									<div class="col-lg-6">
										<input type="text" class="form-control" id="alamat_desa" name="alamat_desa" value="<?php echo $data_santri->alamat_desa; ?>" placeholder="Masukkan Desa/Kelurahan..">
								...
								<div class="form-group row">
									...
									<div class="col-lg-6">
										<input type="text" class="form-control" id="alamat_kecamatan" name="alamat_kecamatan" value="<?php echo $data_santri->alamat_kecamatan; ?>" placeholder="Masukkan Kecamatan..">
								...
								<div class="form-group row">
									...
									<div class="col-lg-6">
										<input type="text" class="form-control" id="alamat_kabupaten" name="alamat_kabupaten" value="<?php echo $data_santri->alamat_kabupaten; ?>" placeholder="Masukkan Kabupaten/Kota..">
								...
								<div class="form-group row">
									...
									<div class="col-lg-6">
										<input type="text" class="form-control" id="alamat_provinsi" name="alamat_provinsi" value="<?php echo $data_santri->alamat_provinsi; ?>" placeholder="Masukkan Provinsi..">
								...
								<div class="form-group row">
									...
									<div class="col-lg-6">
										<input type="text" class="form-control" id="no_nik" name="no_nik" value="<?php echo $data_santri->no_nik; ?>" placeholder="Masukkan No. NIK..">
								...
								<div class="form-group row">
									...
									<div class="col-lg-6">
										<input type="text" class="form-control" id="no_hp" name="no_hp" value="<?php echo $data_santri->no_hp; ?>" placeholder="Masukkan No.HP..">
										<?php echo form_error('no_hp', '<div the="text-danger">', '</div>'); ?>
									</div>
								</div>
								<div class="form-group row">
									...
									<div class="col-lg-6">
										<input type="text" class="form-control" id="nama_wali" name="nama_wali" value="<?php echo $data_santri->nama_wali; ?>" placeholder="Masukkan Nama Wali..">
								...
								<div class="form-group row">
									...
									<div class="col-lg-6">
										<input type="text" class="form-control" id="no_hp_wali" name="no_hp_wali" value="<?php echo $data_santri->no_hp_wali; ?>" placeholder="Masukkan No. HP Wali..">
