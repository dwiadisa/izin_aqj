                            ...
                            <div class="card-body">
                                ...
                                <div class="custom-tab-1">
                                    <ul class="nav nav-tabs mb-3">
                                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#home1">Home</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#profile1">Profile</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#contact1">Contact</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#message1">Message</a>
                                        </li>
                                    </ul>
                                    <div class="tab-content">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="nav nav-pills mb-3 justify-content-end">
                                    <li class="nav-item"><a href="#navpills2-1" class="nav-link active" data-toggle="tab" aria-expanded="false">Tab One</a>
                                    </li>
                                    <li class="nav-item"><a href="#navpills2-2" class="nav-link" data-toggle="tab" aria-expanded="false">Tab Two</a>
                                    </li>
                                    <li class="nav-item"><a href="#navpills2-3" class="nav-link" data-toggle="tab" aria-expanded="true">Tab Three</a>
                                    </li>
                                </ul>
                                <div class="tab-content br-n pn">
                                    <div id="navpills2-1" class="tab-pane active">
                                        <div class="row align-items-center text-right">
                                            <div class="col-sm-6 col-md-8 col-xl-10">
                                                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nobis architecto dolor quidem temporibus, itaque aliquid, quasi nulla adipisci laborum quaerat impedit quae, tenetur laudantium tempore deleniti commodi quod praesentium fugiat.</p>
                                                <p>Reprehenderit butcher retro keffiyeh dreamcatcher synth. Cosby sweater eu banh mi, qui irure terry richardson ex squid.</p>
                                            </div>
                                            <div class="col-sm-6 col-md-4 col-xl-2">
                                                <img src="images/big/card-4.png" alt="" class="img-fluid thumbnail m-r-15">
                                    ...
                                    <div id="navpills2-2" class="tab-pane">
                                        <div class="row align-items-center text-right">
                                            <div class="col-sm-6 col-md-8 col-xl-10">
                                                <p>Raw denim you probably haven't heard of them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro synth master cleanse. Mustache cliche tempor, williamsburg carles vegan helvetica.</p>
                                                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Harum accusantium praesentium voluptas, repellendus ipsam sint odit inventore ratione labore ullam molestiae quo, ipsa molestias ipsum quos optio, quidem nisi. Molestiae recusandae ad reiciendis perferendis vel commodi sapiente explicabo, veritatis cupiditate.</p>
                                            </div>
                                            <div class="col-sm-6 col-md-4 col-xl-2">
                                                <img src="images/big/card-2.png" alt="" class="img-fluid thumbnail m-r-15">
                                            </div>
                                        </div>
                                    </div>
                                    <div id="navpills2-3" class="tab-pane">
                                        <div class="row align-items-center text-right">
                                            <div class="col-sm-6 col-md-8 col-xl-10">
                                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam delectus iusto eius eos sunt dolorum. Laudantium, illum autem repellat omnis ipsam temporibus!</p>
                                                <p>Reprehenderit butcher retro keffiyeh dreamcatcher synth. Cosby sweater eu banh mi, qui irure terry richardson ex squid.</p>
                                            </div>
                                            <div class="col-sm-6 col-md-4 col-xl-2">
                                                <img src="images/big/card-1.png" alt="" class="img-fluid thumbnail m-r-15">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-4 col-lg-3">
                                        <div class="nav flex-column nav-pills"><a href="#v-pills-home" data-toggle="pill" class="nav-link active show">Home</a> <a href="#v-pills-profile" data-toggle="pill" class="nav-link">Profile</a> <a href="#v-pills-messages" data-toggle="pill" class="nav-link">Messages</a>
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <div class="tab-content">
                                            <div id="v-pills-home" class="tab-pane fade active show">
                                                <p>Cillum ad ut irure tempor velit nostrud occaecat ullamco aliqua anim Lorem sint. Veniam sint duis incididunt do esse magna mollit excepteur laborum qui.Deserunt non laborum enim et cillum eu deserunt excepteur ea incididunt
                                                    minim occaecat.</p>
                                            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Vertical Nav Pill</h4>
                                <div class="row align-items-center">
                                    <div class="col-md-7 col-xl-9 order-2 order-md-1">
                                        <div class="tab-content">
                                            <div id="v-pills-home1" class="tab-pane text-md-right fade active show">
                                            ...
                                            <div id="v-pills-profile1" class="tab-pane text-md-right fade">
                                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi adipisci cupiditate quo libero doloribus et rem a eos officiis. Eos at consequuntur, fugiat ducimus sapiente sit sequi aliquam, deserunt laboriosam perferendis sed corporis. Unde provident ea quo quibusdam beatae neque.</p>
                                            </div>
                                            <div id="v-pills-messages1" class="tab-pane text-md-right fade">
                                                <p>Fugiat id quis dolor culpa eiusmod anim velit excepteur proident dolor aute qui magna. Ad proident laboris ullamco esse anim Lorem Lorem veniam quis Lorem irure occaecat velit nostrud magna nulla. Velit
                                                    et et proident Lorem do ea tempor officia dolor. Reprehenderit Lorem aliquip labore est magna commodo est ea veniam consectetur.</p>
                                            </div>
                                            <div id="v-pills-settings1" class="tab-pane text-md-right fade">
                                    ...
                                    <div class="col-md-5 col-xl-3 order-1 order-md-2 mb-3 mb-md-0">
                                        <div class="nav flex-column nav-pills"><a href="#v-pills-home1" data-toggle="pill" class="nav-link active show">Home</a> <a href="#v-pills-profile1" data-toggle="pill" class="nav-link">Profile</a> <a href="#v-pills-messages1" data-toggle="pill" class="nav-link">Messages</a>
