                                                        ...
                                                        <div id="v-pills-<?php echo $k->id_kamar; ?>" class="tab-pane fade <?php echo $k === reset($kamar) ? 'active show' : ''; ?>">
                                                            ...
                                                            foreach ($penghuni as $p): ?>
                                                                <li class="list-group-item">
                                                                    ...
                                                                    <button type="button" class="btn btn-danger btn-sm float-right ml-2" data-toggle="modal" data-target="#confirmDeleteModal<?php echo $p->id_penghuni; ?>">Hapus</button>
                                                                    
                                                                    <!-- Modal -->
                                                                    <div class="modal fade" id="confirmDeleteModal<?php echo $p->id_penghuni; ?>" tabindex="-1" role="dialog" aria-labelledby="confirmDeleteLabel<?php echo $p->id_penghuni; ?>" aria-hidden="true">
                                                                        <div class="modal-dialog" role="document">
                                                                            <div class="modal-content">
                                                                                <div class="modal-header">
                                                                                    <h5 class="modal-title" id="confirmDeleteLabel<?php echo $p->id_penghuni; ?>">Konfirmasi Hapus</h5>
                                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                        <span aria-hidden="true">&times;</span>
                                                                                    </button>
                                                                                </div>
                                                                                <div class="modal-body">
                                                                                    Apakah Anda yakin ingin menghapus penempatan ini?
                                                                                </div>
                                                                                <div class="modal-footer">
                                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                                                                                    <a href="<?php echo site_url('data_penempatan_santri/hapus_penempatan/') . $p->id_penghuni; ?>" class="btn btn-danger">Hapus</a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
