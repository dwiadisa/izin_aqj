                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <button class="dropdown-item btn-delete" data-id="<?php echo $us->id_user ?>" data-name="<?php echo $us->nama_lengkap ?>">Hapus</button>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
...
<script>
    $(document).ready(function() {
        $('.btn-delete').click(function() {
            ...
            $('#confirmDelete').attr('href', '<?php echo base_url("data_user/hapus_user/"); ?>' + id);
