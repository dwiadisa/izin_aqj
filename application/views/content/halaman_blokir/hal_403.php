					...
					<div class="error-content">
						<div class="card mb-0">
							<div class="card-body text-center">
								...
								<h4 class="mt-4"><i class="fa-solid fa-circle-xmark"></i> Akses Ditolak</h4>
								<p>Akses halaman ini ditolak.</p>
								<form class="mt-5 mb-5">

									<div class="text-center mb-4 mt-4"><a href="<?php echo base_url('dashboard') ?>" class="btn btn-success">Kembali ke Dashboard</a>
									</div>
								</form>
