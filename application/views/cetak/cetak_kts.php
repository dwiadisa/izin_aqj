...
<div class="container mt-5">
  <div class="row justify-content-start">
    <div class="col-4">
     <img src="<?php echo empty($santri->foto) ? base_url('assets/images/user.png') : base_url($santri->foto); ?>" class="foto img-thumbnail" alt="foto">
    </div>
    <div class="col">
    ...
    <tr>
        <th>TTL</th>
        <td>:</td>
        <td><?php echo $santri->tempat_lahir?>, <?php echo $santri->tanggal_lahir; ?></td>
    </tr>
    <tr>
        <th>Alamat</th>
        <td>:</td>
        <td><?php echo $santri->alamat_dusun . ', ' . $santri->alamat_desa . ', ' . $santri->alamat_kecamatan . ', ' . $santri->alamat_kabupaten . ', ' . $santri->alamat_provinsi; ?></td>
    </tr>
</table>
